    ...
    <div>
      ...
      <section className="relative bg-white overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <img
            src="https://images.unsplash.com/photo-1470252649378-9c29740c9fa8?w=1920&h=800&fit=crop"
            alt="Sunflower field"
          ...
          <div className="max-w-3xl space-y-8">
            <div className="space-y-4">
              <div className="inline-flex items-center gap-2 text-sm text-gray-700">
                ...
                <span className="font-medium">A softer corner of the internet</span>
              </div>
            ...
            <div className="flex flex-wrap gap-3">
              <Link
                href="/signup"
                className="px-6 py-3 rounded-lg bg-yellow-400 hover:bg-yellow-500 text-base font-semibold text-gray-900 transition-colors shadow-md hover:shadow-lg"
              >
                Get started
              </Link>
              <Link
                href="/journal"
                className="px-6 py-3 rounded-lg bg-white border border-gray-300 hover:border-gray-400 text-base font-medium text-gray-700 hover:text-gray-900 transition-colors shadow-sm hover:shadow-md"
              >
                Read the journal
              </Link>
            </div>
      ...
      <div className="bg-gray-50">
        <div className="max-w-7xl mx-auto px-6 py-16 md:py-24 space-y-16">
          ...
          <section>
            <div className="bg-white rounded-xl p-8 md:p-10 space-y-6 border border-gray-200 max-w-3xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <button className="px-6 py-3 rounded-lg bg-gray-900 hover:bg-gray-800 text-sm font-semibold text-white transition-colors shadow-md hover:shadow-lg">
                Read more →
              </button>
            </div>
          </section>
        ...
        <section className="space-y-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {/* Featured Journal */}
            <div className="bg-white border border-gray-200 rounded-xl overflow-hidden shadow-md hover:shadow-xl hover:border-gray-300 transition-all group">
        ...
        <section className="space-y-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-[#254331] rounded-xl p-6 space-y-3 shadow-lg hover:shadow-xl transition-shadow">
              <div className="w-10 h-10 rounded-lg bg-yellow-400 flex items-center justify-center text-xl font-bold text-gray-900 shadow-md">
                1
              </div>
        ...
        {/* CALL TO ACTION */}
        <section className="bg-white rounded-xl p-8 md:p-12 space-y-6 border border-gray-200 shadow-lg hover:shadow-xl transition-shadow">
